...
with st.sidebar:
    ...
    st.info(
        """Example Questions:
1. What is the list of works in the tunnel project? 
...
st.title("Question-Answering System for Tunnel Risks :red[(QASTRisk)🔎]")

st.markdown(
    "##### :red[A Question-Answering System for Identifying Risks in Tunnel Projects]"
)
